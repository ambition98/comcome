...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.html"><img src="<c:url value='/resources/img/logo-dark.png'/>" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="<c:url value='/resources/img/user.png'/>" class="img-circle" alt="Avatar"> <span>Samuel</span></a>
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="index.html" class="active"> <span>회원 조회 및 검색</span></a></li>
						<li><a href="elements.html" class=""> <span>쪽지 보내기</span></a></li>
						<li><a href="charts.html" class=""> <span>게시글 관리</span></a></li>
						<li><a href="panels.html" class=""> <span>특가몰 관리</span></a></li>
						<li><a href="notifications.html" class=""> <span>팝업 공지 등록</span></a></li>
						<li>
