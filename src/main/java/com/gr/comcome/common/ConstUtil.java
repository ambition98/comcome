...
public interface ConstUtil {
	...
	String FILE_UPLOAD_PATH_TEST="C:\\lecture\\workspace_list\\spboot_ws\\springherb\\src\\main\\webapp\\pds_upload";
	
	//관리자 페이지 - 상품 등록시 상품 이미지 저장 경로
	String IMAGE_FILE_UPLOAD_PATH="pd_images";
	String IMAGE_FILE_UPLOAD_PATH_TEST="c:\\lecture\\workspace_list\\spboot_ws\\springherb\\src\\main\\webapp\\resources\\pd_images";
